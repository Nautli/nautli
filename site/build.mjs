...
const pages = ["index", "diagnose", "gallery", "manifesto", "install", "faq", "c"];
...
const assetVersions = {
  ...
  gallery: await assetHash("gallery.js"),
};
...
await copyFile(path.join(srcDir, "gallery.js"), path.join(distDir, "gallery.js"));
